...
REM
REM Generated by Vivado on Sun Feb 08 02:42:49 +0200 2026
...
echo "xvlog --incr --relax -prj CLA_16_bit_vlog.prj"
call xvlog  --incr --relax -prj CLA_16_bit_vlog.prj -log xvlog.log
